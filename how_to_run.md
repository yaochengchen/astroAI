# How to Run the AstroAI Pipeline
...
```bash
# Code
wget https://zenodo.org/records/18612199/files/ambra-dipiano/astroAI-v1.2.2.zip?download=1

# Dataset
wget https://zenodo.org/records/11086320/files/simulations_dataset_v1.zip?download=1

# Models
wget https://zenodo.org/records/11086320/files/crta_models_v1.zip?download=1
```
...
python make_noisy_clean_from_dl3.py \
    -f conf_pairs.yml \
    -o /home/cyc/software/astroAI/dataset/simulations_dataset_v1/dl3_z20_irf/output_pairs
